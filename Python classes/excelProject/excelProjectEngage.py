...
def traineeMenu():
    ...
    while(ch!="9"):
        ...
        if (ch == "1"):
            ...
            index = getIndex(courseID, "Course Details")
            if (index == -1):
...
def courseMenu():
    ...
    while (ch != "9"):
        print("Course Menu: ")
        print("1: Add Course, 2: Update Course, 3:Delete Course")
        print("9: End")
        print("Please enter your choice: ")
        ch = input()
        print()
...
while(ch!="9"):
    ...
    print("4: Manager Menu, 5: Add Session")
    print("9: End")
    print("Please enter your choice: ")
    ch = input()
    print()
